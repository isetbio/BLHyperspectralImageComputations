function sensorData = retrieveSensorData(sceneSetName, resultsDir, decoder, targetLdecoderXYcoords, targetMdecoderXYcoords, targetSdecoderXYcoords)
    ...
    sensorData.spatialSizeX = sensorData.spatialSupportX(end)-sensorData.spatialSupportX(1);
    sensorData.spatialSizeY = sensorData.spatialSupportY(end)-sensorData.spatialSupportY(1);
