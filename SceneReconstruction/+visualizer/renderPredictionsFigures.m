function renderPredictionsFigures(sceneSetName, descriptionString, InSampleOrOutOfSample)
    ...
    if (strcmp(InSampleOrOutOfSample, 'InSample'))
        ...
        fprintf('Done.\n');
        imageFileName = generateImageFileName(InSampleOrOutOfSample, descriptionString, expParams);
...
function renderReconstructionPerformancePlots(imageFileName, C, Creconstruction, originalStimulusSize, expParams)
    ...
    LMScontrastSequenceReconstruction  = ...
        decoder.reformatStimulusSequence('FromDesignMatrixFormat', ...
            decoder.shiftSequence(Creconstruction, expParams.decoderParams), ...
            originalStimulusSize ...
        );
  
    LMScontrastSequence  = ...
        decoder.reformatStimulusSequence('FromDesignMatrixFormat', ...
            decoder.shiftSequence(C, expParams.decoderParams), ...
            originalStimulusSize ...
        );
