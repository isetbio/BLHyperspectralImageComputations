function RunExperiment
    ...
    decoderParams = struct(...
        ...
        'spatialSamplingInRetinalMicrons', 2.0, ...                 % decode scene ((retinal projection)) at 5 microns resolution
        'extraMicronsAroundSensorBorder', 20, ...                   % decode this many additional microns on each side of the sensor
