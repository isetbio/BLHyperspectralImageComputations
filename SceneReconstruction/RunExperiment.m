...
function expParams = experimentParams()
        ...
        'extraMicronsAroundSensorBorder', 3, ...                   % decode this many additional microns on each side of the sensor
        'temporalSamplingInMilliseconds', 8*2, ...                    % decode every this many milliseconds
        'latencyInMillseconds', -160+80, ...
        'memoryInMilliseconds', 560-160 ...
    );
