function computeOutOfSamplePrediction(sceneSetName, descriptionString)
    ...
    load(fileName, 'Xtest', 'Ctest', 'testingTimeAxis', 'testingSceneIndexSequence', 'testingSensorPositionSequence', 'testingScanInsertionTimes', 'testingSceneLMSbackground', 'testingOpticalImageLMSbackground', 'originalTestingStimulusSize', 'expParams');
    fprintf('Done.\n');
    ...
    save(fileName,  'Ctest', 'CtestPrediction', 'testingTimeAxis', 'testingSceneIndexSequence', 'testingSensorPositionSequence', 'testingScanInsertionTimes', 'testingSceneLMSbackground', 'testingOpticalImageLMSbackground', 'originalTestingStimulusSize', 'expParams', '-v7.3');
    fprintf('Done after %2.1f minutes.\n', toc/60);
