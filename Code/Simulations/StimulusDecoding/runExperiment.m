function runExperiment
  ...
  %  runMode = {'visualizeOutOfSamplePredictions'}
    ...
    if (ismember('compute outer segment responses', runMode))
        ...
        % 5a. Compute out-of-sample predictions
        ...
        % 5b. Visualize out-of-sample predictions
        visualizeOutOfSamplePredictions(rootPath, decodingParams.exportSubDirectory, osType, adaptingFieldType, experimentConfiguration);
    ...
    elseif (ismember('computeOutOfSamplePredictions', runMode))
        ...
        % 5b. Compute out-of-sample predictions
        visualizeOutOfSamplePredictions(rootPath, decodingParams.exportSubDirectory, osType, adaptingFieldType, experimentConfiguration);

    elseif (ismember('visualizeOutOfSamplePredictions', runMode))
