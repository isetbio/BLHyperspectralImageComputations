...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScenes9Through16(obj)
    ...
    switch obj.sceneData.name
        case 'scene9'
            ...
            sceneInfo = 'Pink flower tree closeup. Spatial scale estimated. Illuminant set to D65 with 1000 cd/m2 mean luminance.';
        ...
        case 'scene10'
             % Manual scene description
            sceneInfo = 'Forest view. Motion artifacts. Spatial scale estimated. Illuminant set to D65 with 300 cd/m2 mean luminance.';
        ...
        case 'scene11'
             % Manual scene description
            sceneInfo = 'Foliage. Motion artifacts. Spatial scale estimated. Illuminant set to D65 with 2000 cd/m2 mean luminance.';
        ...
        case 'scene12'
             % Manual scene description
            sceneInfo = 'Valley view. Motion/out-of-focus artifacts. Spatial scale estimated. Illuminant set to D65 with 2000 cd/m2 mean luminance.';
        ...
        case 'scene13'
             % Manual scene description
            sceneInfo = 'Toys. Indoors. Spatial scale estimated. Illuminant set to D65 with 200 cd/m2 mean luminance.'; 
        ...
        case 'scene14'
             % Manual scene description
            sceneInfo = 'Old building and tree view. Sunny day. Spatial scale estimated. Illuminant set to D65 with 2000 cd/m2 mean luminance.';
        ...
        case 'scene15'
            % Manual scene description
            sceneInfo = 'Building view. Sunny day. Spatial scale estimated. Illuminant set to D65 with 2500 cd/m2 mean luminance.';
        ...
        case 'scene16'
            % Manual scene description
            sceneInfo = 'City view. Sunny day. Spatial scale estimated. Illuminant set to D65 with 3000 cd/m2 mean luminance.';
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene1(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['Forest view. Spatial and illuminant data available. Scene was recorded in the Sameiro area, Braga, Minho region, Portugal, on 12 July 2003 at 15:10 '...
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene2(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['Dense foliage with purple flower. Spatial and illuminant data available. Scene was recorded in Ruivães, Vieira do MInho, Minho region, Portugal, on 4 July 2003 at 14:50 under overcast sky with '...
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene3(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['Garden. Spatial and illuminant data available. Scene was recorded in the Museum of the Monastery of S. Martinho de Tibães, Mire de Tibães, Minho region, Portugal, ' ...
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene4(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['Yellow flower close up. Spatial and illuminant data available. Recorded in the Gualtar campus of University of Minho, Portugal, on 31 July 2002 at 17:40 ' ...
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene5(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['Data inconsistency (32/33 bands). Spatial and illuminant data available. Scene was recorded at Brufe, Terras do Bouro, Minho region, Portugal, on 25 July 2002 at 16:15 '...
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene6(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['City view. Spatial and illuminant data available. Scene was recorded in the Picoto area, Braga, Minho region, Portugal, on 8 August 2002 at 12:57 '...
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene7(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['Beautiful redroof buildings. Spatial and illuminant data available. Scene was recorded in the Ribeira area, Porto, Portugal, on 10 July 2003 at 15:05 under '...
                  'direct sunlight with thin clouds and a slight wind. Ambient temperature was 26 ºC. '...
...
function referenceObjectData = generateReferenceObjectDataStructForManchesterScene8(referencePaintMaterialFileName)
    ...
    referenceObjectData = struct(...
        'spectroRadiometerReadings', struct( ...    % Spectro-radiometer readings from the reference object
         ...
         'info', ['Stone and wood cabin closeup. Spatial and illuminant data available. Scene was recorded in Souto, Minho region, Portugal, on 8 July 2003 at 13:17 under '...
