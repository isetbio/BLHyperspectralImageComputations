classdef PennHyperSpectralImageDataExtractor < HyperSpectralImageDataExtractor
    %PENNHYPERSPECTRALIMAGEDATAEXTRACTOR A @HyperspectralImageDataExtractor subclass, specialized for the Penn data base
    ...
    methods
        function obj = PennHyperSpectralImageDataExtractor(sceneName)
            ...
            obj.sceneData = struct(...
                'database', databaseName, ...              % database directory'subset',   
